...
(define INIT-BOARD
  (vector (vector W W W W W W W W W W W W W W W W W W W W)
          (vector W C D D D D D D D D W D D D D D D D D W)
          (vector W D W W D W W W D D W D D W W W C W D W)
          (vector W D W W D D W D D D W D D W W W D W D W)
          (vector W D D D D D W D D D D D D D D D D D D W)
          (vector W D W W D D W D W W W W W D D W D W D W)
          (vector W D W W D D E D D D W D D D D W D W D W)
          (vector W D D D D W W W D D W D D D W W D W D W)
          (vector W D W W D W D D D D D D D D D W D D D W)
          (vector W D D W D D D D D W W D W W D W D D D W)
          (vector W D D W D D D W D D D D D W D D D W D W)
          (vector W D D D D W W W D W C D D D D D D W D W)
          (vector W D D W D D D W D W W D W W D W D W D W)
          (vector W D D W C D D D D D D D D D D W D D D W)
          (vector W D W W D W D D D D W D D W W W D W D W)
          (vector W D D D D W W W D D W D D D D W D C D W)
          (vector W D D D D W D D D D W D D D D W D W D W)
          (vector W D W W D D D D W W W W W D D D D W D W)
          (vector W D W W D W W D D D D D D D D D W W D W)
          (vector W D D C D D D D D D W D D D D D D D D W)
...
(define PM (scale 0.5 (bitmap "grafx/pac_open.png")))

(define R-PM PM)
(define U-PM (rotate 90 R-PM))
(define L-PM (rotate 180 R-PM))
(define D-PM (rotate 270 R-PM))
(define C-PM (scale 0.5 (bitmap "grafx/pac_close.png"))) ;close mouth

(define CHERRY (scale 0.5 (bitmap "grafx/cherry.png")))

(define GT (scale 0.5(bitmap "grafx/ghost.png")))
...
(define (last-scene gs)
  (cond [(goal? (ghost->pos (gs-gt gs)) (sprite->pos (gs-pm gs)))
         (overlay/align "middle" "middle" 
                        (above (text "GAME OVER. PACMAN GOT EATEN." 30 "red")
                               (text "Thank you for playing!" 30 "white")
                               (text "Total Time:" 30 "aqua")
                               (text (number->string (ceiling (* TOCK (gs-time gs)))) 30 "aqua")
                               (text "Total Score:" 30 "yellow")
                               (text (number->string (gs-score gs)) 30 "yellow")
                               (text "Final Score:" 30 "red")
                               (text (number->string (final-score (ceiling (* TOCK (gs-time gs))) (gs-score gs))) 30 "yellow"))
                        (place-image (bitmap "grafx/win.jpg") (* 0.5 SCREEN-W)(* 0.5 SCREEN-H) (empty-scene SCREEN-W SCREEN-H)))]        
        [else (overlay/align "middle" "middle" 
                             (above (text "PACMAN EATS ALL THE DOTS." 30 "white")
                                    (text "Thank you for playing!" 30 "white")
                                    (text "Total Time:" 30 "aqua")
                                    (text (number->string (ceiling (* TOCK (gs-time gs)))) 30 "aqua")
                                    (text "Total Score:" 30 "yellow")
...
(define (tick-pm pm bd t)
  (if (and (string=? "L" (sprite-dir pm)) (= (sprite-x pm) 0))
      (make-sprite 20 (sprite-y pm) "L")
      (if (and (string=? "R" (sprite-dir pm)) (= (sprite-x pm) 20))
...
(define (render gs)
  (overlay/align "middle"
                 "center"
                 (above/align "middle"
                              (if (odd? (gs-time gs)) (scale 3(bitmap "grafx/logo_1.png")) (scale 3(bitmap "grafx/logo_2.png")))
                              (render-time (ceiling (* 0.25 (gs-time gs)))
                                           (render-ghost (gs-gt gs)
                                                         (render-pm (gs-pm gs)
                                                                    ...
                                                                    (gs-time gs))
                                                         (gs-time gs))))
                 (place-image (bitmap "grafx/bckg.jpg") (* 0.5 SCREEN-W) (* 0.5 SCREEN-H) (empty-scene SCREEN-W SCREEN-H))))
...
(define (render-ghost ghost img t)
  (local [(define GT-IMG
            (cond [(= 1 (modulo t 4)) (scale 0.5(bitmap "grafx/ghost_2.png"))]
                  [(= 2 (modulo t 4)) (scale 0.5(bitmap "grafx/ghost.png"))]
                  [(= 3 (modulo t 4)) (scale 0.5(bitmap "grafx/ghost_2.png"))]
                  [else
                   GT]))]
